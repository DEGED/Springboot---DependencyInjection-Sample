...
public class AppConfig {
	...
	/*
	 * Registrando  componentes desde la configuracion y con la anotacion bean
	 */
	@Bean("miServicioSimple")
	@Primary
	public IServicio registraraMiServicio() {
		return new MiServicio();
	}

	@Bean("miServicioComplejo")
	public IServicio registraraMiServicioComplejo() {
